<form class="form form-horizontal form-inline company-form " id="company_calendar_unlink" role="form" method="post" action="index.php/?process=calendar_company_add"><div class="form-group col-xs-12 col-sm-0 m-3 mt-md-4"><label class="control-label mr-2 mb-2" for="company">Company</label>
		...
		<div class="form-group">
		    <div class="col-sm-offset-2 col-sm-10">
		      <button type="submit" id="company_calendar_unlink" class="btn btn-primary"> Add Calendar</button>
		    </div>
	  	</div></form>