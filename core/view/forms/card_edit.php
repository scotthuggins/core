<form class="form form-horizontal" id="card_edit" role="form" method="post" action="index.php/?process=card_edit"><div class="form-group"><span class="col-12 bg-danger"><?php echo GetErrors(); ?></span></div><div class="form-group">
  		...
  		<input hidden type="text" class="form-control card_id" name="id" value="<?php if(isset($session->form['id'])){echo $session->form['id'];}?>" id="id" placeholder="Id of the new card" autocomplet="off" autofocus="on">
		<div class="form-group">
		    <div class="col-sm-offset-2 col-sm-10">
		      <button type="submit" id="card_edit" class="btn btn-primary">Edit Card</button>
		    </div>
	  	</div></form>