<form class="form-horizontal" role="form" method="post" action="index.php/?process=role_permission_add">
      ...
      <select class="form-control" id="permission" name="permission">
      	<?php
			...
			foreach($permission_table->entities as $permission){
				echo '<option value="'.$permission->id.'">'.$permission->name.'  [Desc:'.$permission->description.']</option>';
			}
      	?>
      </select>
    </div>
