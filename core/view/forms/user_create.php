<form class="form form-horizontal" id="user_create" role="form" method="post" enctype="multipart/form-data" action="index.php/?process=user_create"><div class="form-group">
		...
		<div class="form-group">
		    <div class="col-sm-offset-2 col-sm-10">
		      <button type="submit" id="user_create" class="btn btn-primary">Create User</button>
		    </div>
	  	</div></form>